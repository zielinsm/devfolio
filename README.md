...
Another straightforward way to deploy devfolio is to use Vercel. The platform also offers a Hobby plan that will allow you to host the project free-of-charge.

You can deploy the project with just a few clicks:
...
As with Netlify, you can also deploy the project manually following identical settings.
